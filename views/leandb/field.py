...
from flask_admin.contrib.mongoengine import widgets
...
class LeanFileField(fields.FileField):
    widget = widgets.MongoFileInput()

    def __init__(self, label=None, validators=None, **kwargs):
        super(LeanFileField, self).__init__(label, validators, **kwargs)
    ...
    def process(self, formdata, data=unset_value):
        ...
        return super(LeanFileField, self).process(formdata, data)
...
class LeanImageField(LeanFileField):
